  ...
  return (
    <section id="about" className="container py-24 space-y-16">
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground text-lg max-w-3xl mx-auto font-mono">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <div className="space-y-6">
          <h3 className="text-2xl font-heading font-bold">My Background</h3>
        ...
        <div className="grid gap-6">
          <Card>
            <CardContent className="p-6 flex items-start gap-4">
              ...
              <div>
                <h4 className="font-heading font-bold">Software Engineering</h4>
                <p className="text-muted-foreground font-mono">
          ...
          <Card>
            <CardContent className="p-6 flex items-start gap-4">
              ...
              <div>
                <h4 className="font-heading font-bold">Product Design</h4>
                <p className="text-muted-foreground font-mono">
          ...
          <Card>
            <CardContent className="p-6 flex items-start gap-4">
              ...
              <div>
                <h4 className="font-heading font-bold">Academic Excellence</h4>
                <p className="text-muted-foreground font-mono">
