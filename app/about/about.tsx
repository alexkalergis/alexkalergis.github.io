          ...
          <div className="grid lg:grid-cols-2 gap-8 items-stretch">
              ...
              <CardContent className="p-8 flex-1 flex flex-col">
                ...
                <div className="space-y-6 flex-1 flex flex-col">
                  <div className="space-y-3">
                    ...
                    >
                      My path into technology began with a Master's in
                      Electrical & Computer Engineering from the University of
                      Patras. My academic focus on Cyber-Physical Systems
                      immersed me in the exciting realms of Artificial
                      Intelligence, Machine Learning, and Human-Computer
                      Interaction.
                    </p>
                  </div>
                </div>
            ...
            <Card className="border bg-card/50 backdrop-blur-sm flex flex-col">
              <CardContent className="p-8 flex-1 flex flex-col">
                ...
                <div className="space-y-6 flex-1 flex flex-col">
                  <div className="space-y-3">
                    <h4 className="font-bold leading-tight text-lg">
        ...
        <div className="container space-y-16">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-lg">
              My certifications and awards in the field of technology and
              engineering.
            </p>
          </div>
            ...
            <Card className="border bg-card/50 backdrop-blur-sm flex flex-col">
              <CardContent className="p-8 flex-1 flex flex-col">
                ...
                <div className="space-y-6 flex-1 flex flex-col">
                  <div className="space-y-3">
                    <div className="flex justify-between items-start">
                      <h4 className="text-lg font-semibold leading-tight">
                        University of Patras (AI-Hub)
                      </h4>
                    </div>
                    <div className="flex justify-between items-start">
                      <p className="text-muted-foreground text-sm">
                        Honorable Mention in AI competition
                      </p>
                      <span className="text-muted-foreground text-xs whitespace-nowrap ml-2">
                        2023
                      </span>
                  ...
                  <div className="grid gap-4 pt-4 border-t border-gray-300 mt-auto">
                    <div>
                      <span className="text-sm text-foreground font-semiboldldldldldout">
                        About
                      </span>
                      <p
                        ...
                        style={{ textJustify: "inter-word" }}
                      >
                        This project explores Reinforcement Learning methods in
                        robotic systems designed to mimic human actions. We
                        developed an RL-based locomotion controller for a 6-DOF
                        robot to learn walking and implemented a Deep Q-Learning
                        algorithm on a 2-DoF robot to learn handwriting. This
                        research aims to advance AI-driven motor learning in
